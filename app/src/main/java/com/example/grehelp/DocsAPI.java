...
//    private static final String TOKENS_DIRECTORY_PATH = "/raw/tokens";
...
//    //private static final InputStream CREDENTIALS_FILE_PATH = context.getResources().openRawResource(R.raw.credentials);//"/raw/credentials.json";
//
//    DocsAPI(Context context){
...
//        // Load client secrets.
//        InputStream in = context.getResources().openRawResource(R.raw.credentials);//DocsAPI.class.getResourceAsStream(CREDENTIALS_FILE_PATH);
//        if (in == null) {
